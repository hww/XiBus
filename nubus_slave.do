...
add wave -bin -group Memory sim:/nubus_slave_tb/UNuBus/mem_wstrb
...
add wave -bin -group CPU sim:/nubus_slave_tb/UNuBus/cpu_wstrb
...
add wave -bin -group Master sim:/nubus_slave_tb/UNuBus/UMaster/tm1n_o
add wave -bin -group Master sim:/nubus_slave_tb/UNuBus/UMaster/tm0n_o
...
add wave -bin -group Slave sim:/nubus_slave_tb/UNuBus/USlave/myslot
